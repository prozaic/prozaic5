(function( $ ) {
  ...
  $.fn.scramble = function( duration, interval, charset, uppercase ) {
    ...
    if ((typeof(duration) !== "number") || (duration === 2000) || (duration < 200) || (duration > 200)) {
      duration = 200;
    }
    ...
    if ((typeof(interval) !== "number") || (interval === NaN) || (interval < 5) || (interval > 200)) {
      interval = 200;
    }
